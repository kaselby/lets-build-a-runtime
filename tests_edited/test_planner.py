...
from runtime_edited.ir import Graph, OpType
from runtime_edited.ops import OP_REGISTRY
from runtime_edited.planner import (
    ExecutionPlan,
    Lifetime,
    _assign_offsets,
    _compute_lifetimes,
...
class TestPlan:
    ...
    def test_invalid_graph_raises(self):
        """plan() should raise on an invalid graph."""
        g = Graph()
        g.add_tensor("x", (4, 8))
        g.inputs.append("x")
        # No outputs — validation should fail
